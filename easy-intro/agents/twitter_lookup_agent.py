...
def lookup(name: str) -> str:
    ...
    template = """
    Given the full name {name_Of_Person}, I want you to find the twitter profile of the person
    Your answer should only contain the twitter user handle
    """
    ...
    tools_for_agents = [
        Tool(
            ...
            description="Crawl google to find the Twitter handle of the person",
        )
    ]
